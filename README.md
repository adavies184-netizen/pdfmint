# PDFBreeze Engine — Sevalla-ready v1.0.2
...
ALLOWED_ORIGINS=https://pdfbreeze.net
WEB_CONCURRENCY=1
```

## DOC export behaviour

PDFBreeze now tries multiple LibreOffice DOC export modes automatically:
...
PyMuPDF extracts text positions, PDFBreeze groups them into simple rows and
